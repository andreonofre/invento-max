    ...
    <Container>
      ...
      <Content>
        ...
        <StyledAutocomplete
          ...
          sx={{ width: 400 }}
          className="corredor"
          options={localizations.map((item) => item.label)}
          renderInput={(params) => (
            <StyledTextField
              {...params}
              label="Localização Corredor"
              variant="outlined"
            />
          )}
          value={localization}
          onChange={(event, newValue) => setLocalization(newValue)}
        />
        ...
        <StyledAutocomplete
          ...
          sx={{ width: 400 }}
          className=""
          options={prateleiras.map((item) => item.label)}
          renderInput={(params) => (
            <StyledTextField
              {...params}
          ...
          value={prateleira}
          onChange={(event, newValue) => setPrateleira(newValue)}
        />
